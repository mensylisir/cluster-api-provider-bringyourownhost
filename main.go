...
import (
	...
	byohcontrollers "github.com/mensylisir/cluster-api-provider-bringyourownhost/controllers/infrastructure"
...
func main() {
	...
	if err = infrastructurev1beta1.SetupMutatingWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create mutating webhook", "webhook", "BootstrapKubeconfig")
		os.Exit(1)
	}
